...
exp=exp/torch_ENV_CLN_Net_C2LSTM_BEGAN_mse_01gan_PRETRAIN
mkdir -p $exp
...
CUDA_VISIBLE_DEVICES=${gpu}  python steps_torch_env_BEGAN_PRETRAIN/train_torch_FDLP_4C2LSTM_mse_01gan.py ${dev}  ${train} ${target_tr} ${target_cv} $exp ${ali}
