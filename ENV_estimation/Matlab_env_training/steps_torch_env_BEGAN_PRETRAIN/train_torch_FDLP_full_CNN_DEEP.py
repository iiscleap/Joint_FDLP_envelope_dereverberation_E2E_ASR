...
from data_gen.dataGeneratorCNN_deep import dataGeneratorCNN_multiAll
import numpy
import sys
#from Net_cnn_deep import Net
from NET.Net_full_cnn_deep import Net
...
print("########### Bad Optima, reducing learning rate ###########")
