...
from data_gen.dataGeneratorCNN_multiAll_LSTM_200X36 import dataGeneratorCNN_multiAll
import numpy
import sys
#from Net_larg_kernel_64_filters import Net
from NET.Net_CNN_2LSTM_padding_64filters_last2_200x36 import Net
...
#          print ('[%d,%5d] loss_tr: %.3f' % (epoch+1,i+1,running_loss_tr/trGen.numSteps))
          print ('TRAIN ==> [%d,%5d] LOSS: %.3f '%(epoch+1,i+1,running_loss_tr/3000))
          running_loss_tr =0.0
...
#           print ('[%d,%5d] loss_cv: %.3f' % (epoch+1,j+1,running_loss_cv/cvGen.numSteps))
           self.losscv_current=running_loss_cv/(300)
           print ('VALID ==> [%d,%5d] LOSS_CV: %.3f '%(epoch+1,j+1,running_loss_cv/(300)))
           running_loss_cv =0.0
