...
#from NET.Net_CNN_3Layer_LSTM_padding_64filters import Net
        ...
        for i, data in enumerate(trGen, 0):
            ...
            if i % 5200 == (5200 - 1):
                ...
                print('TRAIN ==> [%d,%5d] LOSS: %.3f ' %
                      (epoch+1, i+1, running_loss_tr/5200))
                running_loss_tr = 0.0
...
# corss validation step"""
        ...
        for j, data in enumerate(cvGen, 0):
            ...
            if j % (600) == ((600) - 1):
                ...
                self.losscv_current = running_loss_cv/(600)
                print('VALID ==> [%d,%5d] LOSS_CV: %.3f ' %
                      (epoch+1, j+1, running_loss_cv/(600)))
                running_loss_cv = 0.0
