...
class Net (nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(64,128,kernel_size=(21,5),padding=(10,2))
        #self.drop3 = nn.Dropout(0.2)
        self.conv4 = nn.Conv2d(128,128,kernel_size=(21,5),padding=(10,2))
        #self.drop4 = nn.Dropout(0.2)
        self.lstm1 = nn.LSTM(36*128, 1024 , batch_first=True) 
    ...
    def forward(self, x):
        ...
        x = x.transpose(1,2)        
        x = torch.reshape(x,(-1,800,36*128))
        x,_ = self.lstm1(x)
        x,_ = self.lstm2(x)   
        return x
