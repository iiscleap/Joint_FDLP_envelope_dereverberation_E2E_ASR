...
class Net (nn.Module):
    def __init__(self):
        ...
        self.drop1 = nn.Dropout(0.2)
        self.conv2 = nn.Conv2d(32,8,kernel_size=(10,5))
        self.B2    = nn.BatchNorm2d(8,track_running_stats=False)
        self.drop2 = nn.Dropout(0.2)
        self.pool2 = nn.MaxPool2d(kernel_size=(4,2))
        self.fc1   = nn.Linear(47*6*8,1024)
        self.B3    = nn.BatchNorm1d(1024,track_running_stats=False)
        self.drop3 = nn.Dropout(0.2)
        self.fc2   = nn.Linear(1024,1024)
        self.B4    = nn.BatchNorm1d(1024,track_running_stats=False)
