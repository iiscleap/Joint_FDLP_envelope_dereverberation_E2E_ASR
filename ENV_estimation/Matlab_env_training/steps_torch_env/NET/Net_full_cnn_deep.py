...
class Net (nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1,128,kernel_size=(41,3), padding=(20,1))
        #self.B1    = nn.BatchNorm2d(32,track_running_stats=False)
        self.drop1 = nn.Dropout(0.2)
        self.conv2 = nn.Conv2d(128,128,kernel_size=(41,3), padding=(20,1))
        #self.B2    = nn.BatchNorm2d(32,track_running_stats=False)
        self.drop2 = nn.Dropout(0.2)
        self.conv3 = nn.Conv2d(128,64,kernel_size=(41,3),padding=(20,1))
        #self.B3    = nn.BatchNorm2d(32,track_running_stats=False)
        self.drop3 = nn.Dropout(0.2)
        self.conv4 = nn.Conv2d(64,32,kernel_size=(41,3), padding=(20,1))
        #self.B4    = nn.BatchNorm2d(8,track_running_stats=False)
        self.drop4 = nn.Dropout(0.2)
        self.conv5 = nn.Conv2d(32,1,kernel_size=(41,3), padding=(20,1))
        self.relu  = nn.ReLU()
        #self.tanh  = nn.Tanh()
